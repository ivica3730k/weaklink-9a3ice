"""Streaming helpers shared by the CLI and the Python API: pilot
signal generation, the streaming decoder, and the live-rx poll loop.
PTT lives in :mod:`weaklink.modem.ptt`.
"""
